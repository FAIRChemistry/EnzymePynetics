...
- initial_value
  - Type: float
  - Description: Initial value of the parameter that was used for the parameter estimation.
- lower
  - Type: float
...
- vary
  - Type: bool
  - Description: Whether or not the parameter was varied during the parameter estimation.
